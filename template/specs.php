...
<body <?php body_class(); ?>>
   <div class="container specs">
      ...
      <div class="section layout" id="layout"><h1 class="text-center"><span class="heavy">DECK</span> layout</h1><br>
            <p><a href="/wp-content/themes/diligent/images/diligent-bridge-blueprint.jpg" target="_blank">Deck 1: <em>Fore:</em></a> <a href="/wp-content/uploads/2018/09/diligent-bridge-illust.jpg" target="_blank">Main Bridge</a>, Captain's Ready Room, <a href="/wp-content/uploads/2018/11/observationlounge.jpg" target="_blank">Observation Lounge</a> - <em>Aft:</em> Cargobay 1, Aft Dorsal Torpedo Launcher<br />
