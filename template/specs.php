...
<body <?php body_class(); ?>>
   <div class="container specs">
      ...
      <div class="intro section">
         ...
         <p class="text-center subnav-section"><a href="#layout">deck layout</a> - <a href="#gallery">gallery</a> - 
            <a href="#specifications">technical specifications</a> - <a href="#class_background">class history</a></p>
      </div>
      <div class="section layout" id="layout"><h1 class="text-center"><span class="heavy">DECK</span> layout</h1><br>
            ...
            Deck 3: Transporter Rooms 1, <a href="/wp-content/uploads/2018/09/vipquarters.jpg" target="_blank">VIP Quarters</a>, <a href="/wp-content/uploads/2018/09/officer_quarters.jpg" target="_blank">Crew Quarters (Lt. JG and up)</a>, Science Labs, Aeroponics, Hydroponics, Astrometrics, Holosuites 1 & 2, Conference Rooms<br />
            Deck 4: Computer Core Control Room, <a href="/wp-content/uploads/2019/02/engineering-1.jpg" target="_blank">Main Engineering</a>, Engineering Support, Shuttle Bay<br />
