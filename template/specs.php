...
<body <?php body_class(); ?>>
   <div class="container specs">
      ...
      <div class="section layout" id="layout"><h1 class="text-center"><span class="heavy">DECK</span> layout</h1><br>
            ...
            Deck 5: Transporter Rooms 2 and 3, <a href="/wp-content/uploads/2018/09/sickbay.jpg" target="_blank">Medical Bay</a>, <a href="/wp-content/uploads/2018/09/aft_lounge.jpg" target="_blank">Aft Lounge (The Stern)</a>, Navigational Deflector Control, Security Center<br />
