   ...
   ?>
      ...
      <div class="intro section">
         ...
         <p class="text-center subnav-section"><a href="#command">Command</a> - <a href="#counseling">Counseling</a> - <a href="#engineering">Engineering</a>
            ...
            <a href="#tactical">Tactical/Security</a></p>
         <p class="text-center subnav-section">
            <a href="#" class="openButton openToggle">hide open positions</a><a href="#" class="hidden openButton openToggle">show
               open positions</a> -
            <a href="#" class="npc-open-btn npc-toggle">hide non-player characters</a><a href="#" class="hidden npc-open-btn npc-toggle">show
               non-player characters</a>
         </p>
      </div>
         ...
         <div class="manifest">
            ...
            <div class="department section">
               ...
               <div class="row">
                  ...
                  <div class="mani-field character">
                     <p><a href="/manifest/elgor-rae/">Elgor Rae</a></p>
                  </div>
               </div>
               <div class="row">
                  ...
                  <div class="mani-field character">
                     <p><a href="/manifest/marcus-bancroft/">Marcus Bancroft</a></p>
                  </div>
               </div>
               <div class="row">
               ...
               <div class="row npc">
                  ...
                  <div class="mani-field character">
                     <p><a href="/manifest/samuel-rhys-npc">Samuel Rhys <em>(NPC)</em></a></p>
                  </div>
               </div>
            </div>
            ...
            <div class="department section">
               <h3><a href="https://wiki.bravofleet.com/index.php?title=Flight_Control_Department" target="_blank">FLIGHT
                     CONTROL</a></h3>
               <div class="row">
                  <div class="mani-field rank"><img src="/wp-content/themes/diligent/images/pips/navy_gold/r-o3.png" alt="Lieutenant" /></div>
                  <div class="mani-field position">
                     <p>Chief Conn Officer</p>
                  </div>
                  <div class="mani-field character">
                  <p><a href="/manifest/kaden-thiesman">Kaden Thiesman</a></p>
                  </div>
               </div>
               <div class="row open">
                  <div class="mani-field rank"><img src="/wp-content/themes/diligent/images/pips/blank_officer/black.png" /></div>
                  <div class="mani-field position">
                     <p>Assistant Chief Conn Officer</p>
                  </div>
                  <div class="mani-field character">
                     <p><a href="/enlist">Position Available</a></p>
                  </div>
            ...
            <div class="department section open">
               ...
               <div class="row open">
                  <div class="mani-field rank"><img src="/wp-content/themes/diligent/images/pips/blank_officer/black.png" /></div>
                  <div class="mani-field position">
                     <p>Assistant Chief Intel Officer</p>
                  </div>
                  <div class="mani-field character">
                     <p><a href="/enlist">Position Available</a></p>
                  </div>
            ...
            <div class="department section">
               ...
               <div class="row npc">
                  <div class="mani-field rank"><img src="/wp-content/themes/diligent/images/pips/blank_officer/teal.png" /></div>
                  <div class="mani-field position">
                     <p>EMH Mark IV</p>
                  </div>
                  <div class="mani-field character">
                     <p><a href="/manifest/emh/">Doctor Chen <em>(NPC)</em></a></p>
                  </div>
               </div>
            </div>
            ...
            <div class="department section">
               ...
               <div class="row">
                  ...
                  <div class="mani-field character">
                     <p><a href="/manifest/clara-watson">Clara Watson</a></p>
                  </div>
               </div>
               <div class="row open">
                  <div class="mani-field rank"><img src="/wp-content/themes/diligent/images/pips/blank_officer/black.png" /></div>
                  <div class="mani-field position">
                     <p>Assistant Chief of Operations</p>
                  </div>
                  <div class="mani-field character">
                     <p><a href="/enlist">Position Available</a></p>
                  </div>
            ...
            <div class="department section">
               ...
               <div class="row open">
                  <div class="mani-field rank"><img src="/wp-content/themes/diligent/images/pips/blank_officer/black.png" /></div>
                  <div class="mani-field position">
                     <p>Assistant Chief Science Officer</p>
                  </div>
                  <div class="mani-field character">
                     <p><a href="/enlist">Position Available</a></p>
                  </div>
               ...
               <div class="row">
                  ...
                  <div class="mani-field character">
                     <p><a href="/manifest/olepis-blythe">Olepis Blythe</a></p>
                  </div>
               </div>
               <div class="row open">
                  <div class="mani-field rank"><img src="/wp-content/themes/diligent/images/pips/blank_officer/black.png" /></div>
            ...
            <div class="department section">
               ...
               <div class="row">
                  <div class="mani-field rank"><img src="/wp-content/themes/diligent/images/pips/navy_gold/y-o4.png" /></div>
                  <div class="mani-field position">
               ...
               <div class="row open">
                  <div class="mani-field rank"><img src="/wp-content/themes/diligent/images/pips/blank_officer/black.png" /></div>
                  <div class="mani-field position">
                     <p>Deputy Chief of Tactical & Security</p>
                  </div>
                  <div class="mani-field character">
                     <p><a href="/enlist">Position Available</a></p>
                  </div>
            ...
            <p class="text-center disclaimer">The ranks used on this page were created by Kuro-chan of <a href="http://kuro-rpg.net"
                  ...
                  in any way. If you wish to obtain them and an up-to-date copy, access the Kuro-RPG Website.</a></p>
