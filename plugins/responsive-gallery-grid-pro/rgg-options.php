...
function rgg_get_admin_form_structure($skip_submit = false) {
	...
	$admin_form = array(
		'rggpromo' => array(
			'before' => '<h3>Support RGG</h3><p><span class="dashicons dashicons-heart" style="color:#b5322b;"></span> <a href="http://bdwm.be/rgg/responsive-gallery-grid-pro/" target="_blank">Buy RGG Pro for only &euro; 5.90</a> to unlock captions, additional effects, special row options and premium support<br><span class="dashicons dashicons-star-filled" style="color:#ffb900;"></span> or <a href="https://login.wordpress.org/?redirect_to=https%3A%2F%2Fwordpress.org%2Fsupport%2Fplugin%2Fresponsive-gallery-grid%2Freviews%2F" target="_blank">Leave a review</a> if you like RGG.</p>',
			'fields'=>array(),
		),
		...
		'gallery-settings' => array(
			'before' => '<div class="title"><h3>Gallery Settings</h3><p>Default settings for each gallery. You can always overwrite these default options by modifying the <a href="http://bdwm.be/rgg/shortcode-parameters" target="_blank">shortcode parameters</a>.</p></div>',
			'fields' => array(
				'type',
				'class',
				'rel',
...
function rgg_setup_input_fields() {
	...
	$rgg_input_fields['effect'] = array(
		'input_type' => 'select',
		'label' => 'Effect',
		'description' => 'Choose the mouse-over effect. <a href="http://bdwm.be/rgg/responsive-gallery-grid-pro/" target="_blank">Buy RGG Pro</a> for more effects.',
		'options' => array(
			'bubble' => 'Bubble',
			'none' => 'None',
		),
	...
	$rgg_input_fields['captions'] = array(
		'input_type' => 'select',
		'label' => 'Captions',
		'description' => 'Choose how you want the captions to be displayed. <a href="http://bdwm.be/rgg/responsive-gallery-grid-pro/" target="_blank">Buy RGG Pro</a> for more options.',
		'options' => array(
