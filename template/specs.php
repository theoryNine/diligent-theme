...
<body <?php body_class(); ?>>
   <div class="container specs">
      ...
      <div class="section layout" id="layout"><h1 class="text-center"><span class="heavy">DECK</span> layout</h1><br>
         ...
         <p><em>* Image created by and courtesy of <a href="https://forum.bravofleet.com/forum/bravo-fleet-staff-departments/bravo-fleet-graphics-department/completed-works/190-residualrose-s-interior-decorating-warning-gfx-intensive" target="_blank">Residual Rose</a></em></p>
      </div>
