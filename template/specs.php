...
<body <?php body_class(); ?>>
   <div class="container specs">
      ...
      <div class="section layout" id="layout"><h1 class="text-center"><span class="heavy">DECK</span> layout</h1><br>
         <ul>
            <li>Deck 1: <em>Fore:</em> <a href="/wp-content/uploads/2018/09/labeled-bridge.jpg" target="_blank">Main Bridge</a>, Captain's Ready Room, Observation Lounge, <em>Aft:</em> Cargobay 1, Aft Dorsal Torpedo Launcher</li>
