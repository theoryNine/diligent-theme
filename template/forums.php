...
<div class="section user-toolbar"><p><a href="<?php echo do_shortcode('[bbpm-messages-link]') ?>">Unread Messages: <?php echo do_shortcode('[bbpm-unread-count]') ?></a> | Current Episode: <a href="/forums/topic/the-storm-walls">The Storm Walls</a></div>
